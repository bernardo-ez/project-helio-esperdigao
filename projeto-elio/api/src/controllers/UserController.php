...
class UserController {
    private $userDAO;
    private $secretKey = "UMA_CHAVE_SECRETA_MUITO_FORTE_E_ALEATORIA_PARA_O_PROJETO_ELIO"; // Chave segura gerada
    ...
    public function login() {
        ...
        if ($user && password_verify($password, $user->getPassword())) {
            ...
            $serverName = "localhost"; // Substituído para ambiente de desenvolvimento
